...
function validateForm() {
    ...
    if (existingTask && existingPurpose && meetingTasks.indexOf(existingTask) !== -1 && existingTask === currentTask && selectedPurpose === existingPurpose) {
        ...
        $('#radio-group').before('<p id="error-message-1" class="govuk-error-message"><span id="error-1"><span class="govuk-visually-hidden">Error:</span> You cannot create this task because it is already in progress</span></p>');
